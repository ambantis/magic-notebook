...
public class CommentDaoMock implements CommentDao {
    ...
    public ArrayList<Comment> readAll() throws DaoException, DaoConnectionException {
        ...
        Comment c1 = new Comment("1", "1", new Date(), "bill", "Nice job!", "1");
        Comment c2 = new Comment("2", "2", new Date(), "james", "Nice job!", "1");
        Comment c3 = new Comment("3", "3", new Date(), "nancy", "Nice job!", "1");
        Comment c4 = new Comment("4", "4", new Date(), "cindy", "Nice job!", "1");
        Comment c5 = new Comment("5", "5", new Date(), "roger", "Nice job!", "1");
        tmpComments.add(c1);
        tmpComments.add(c2);
        tmpComments.add(c3);
        tmpComments.add(c4);
